...
extension TextUtilsStringExtension on String? {
  ...
  bool get isNotNullEmptyOrWhitespace =>
      !(this == null || this!.isEmpty || this!.trim().isEmpty);
  ...
  String get skipWord {
    ...
    for (; i < this!.length; i++) {
      if (this![i] == ' ' || this![i] == '\t' || this![i] == '\n') {
        return this!.substring(i + 1).trimLeft();
      }
    }
    return '';
  }
  ...
  Color darken(Color c, [int percent = 40]) {
    assert(1 <= percent && percent <= 100);
    final value = 1 - percent / 100;
    return Color.fromARGB(c.alpha, (c.red * value).round(),
        (c.green * value).round(), (c.blue * value).round());
  }
}
