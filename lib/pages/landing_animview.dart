            ...
            children: [
              Transform.translate(
                ...
                child: Image.asset(
                  ...
                  cacheHeight: (arrowHeight * 0.15 * 2).round(),
                ),
              ),
              Transform.rotate(
                angle: -math.pi / 12.0,
                child: Image.asset(
                  ...
                  cacheHeight: (arrowHeight * 2).round(),
                ),
              ),
              Transform.scale(
                ...
                child: Transform.translate(
                  ...
                  child: Image.asset(
                    ...
                    cacheHeight: (arrowHeight * 0.4 * 2).round(),
                  ),
                ),
              )
            ],
              ...
              Transform.translate(
                ...
                child: Transform.scale(
                  ...
                  child: Image.asset(
                    ...
                    cacheHeight: (arrowHeight * 0.6 * 2).round(),
                  ),
                ),
              ),
              Transform.rotate(
      ...
      builder: (context, child) {
        return Transform(
          ...
          transform: Matrix4.identity()
            ..rotateY(_animation.value * 2 * 3.141592),
          child: child,
        );
      },
      child: widget.child,
  ...
  void _setupAnimation() {
    ...
    animation.addListener(() {
      if (scrollController.hasClients) {
        ...
        if (maxScroll > 0) {
          scrollController.jumpTo(animation.value % maxScroll);
        }
      }
    });
