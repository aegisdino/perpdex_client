...
var toString$2 = uncurryThis$j({}.toString);
...
var toString$1 = uncurryThis$g(1.0.toString);
...
var isSymbol$3 = USE_SYMBOL_AS_UID ? function (it) {
  ...
  return isCallable$e($Symbol) && isPrototypeOf$4($Symbol.prototype, $Object$2(it));
};
...
var aCallable$5 = function (argument) {
  ...
  throw new $TypeError$8(tryToString$3(argument) + ' is not a function');
};
...
$$3({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$4 }, {
...
$$2({ target: 'ArrayBuffer', proto: true, unsafe: true, forced: INCORRECT_SLICE }, {
  slice: function slice(start, end) {
    if (nativeArrayBufferSlice && end === undefined) {
      return nativeArrayBufferSlice(anObject$3(this), start); // FF fix
    }
    var length = anObject$3(this).byteLength;
...
var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$1 && classof$6(globalThis$6.opera) !== 'Opera';
...
const Sender = ({
  ...
  const getAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (selectedWalletId === id) {
      yield core.waitFor(() => {
        var _a;
        return !!((_a = _state.wallet) === null || _a === void 0 ? void 0 : _a.isSignedIn());
      }, {
        timeout: 1000
      }).catch();
    }
  ...
  const transformActions = actions => {
    ...
    return actions.map(action => {
      const internalAction = core.najActionToInternal(action);
      return internalAction.type === "FunctionCall" ? internalAction.params : {};
    });
  };
