...
class Provider {
  constructor(urls) {
    this.provider = new providers.FailoverRpcProvider(this.urlsToProviders(urls));
  }
...
const najActionToInternal = action => {
  ...
  if (action.functionCall) {
    ...
    return {
      ...
      params: {
        methodName,
        args: JSON.parse(Buffer.from(args).toString()),
        gas: gas.toString(),
...
const internalActionToNaj = action => {
  ...
  if (action.type === "CreateAccount") {
    return transactions.actionCreators.createAccount();
  }
  if (action.type === "DeployContract") {
    return transactions.actionCreators.deployContract(action.params.code);
  }
  if (action.type === "FunctionCall") {
    return transactions.actionCreators.functionCall(action.params.methodName, action.params.args, BigInt(action.params.gas), BigInt(action.params.deposit));
  }
  if (action.type === "Transfer") {
    return transactions.actionCreators.transfer(BigInt(action.params.deposit));
  }
  if (action.type === "Stake") {
    return transactions.actionCreators.stake(BigInt(action.params.stake), crypto.PublicKey.from(action.params.publicKey));
  }
  if (action.type === "AddKey") {
    return transactions.actionCreators.addKey(crypto.PublicKey.from(action.params.publicKey), new transactions.AccessKey({
      nonce: BigInt((_a = action.params.accessKey.nonce) !== null && _a !== void 0 ? _a : 0),
      permission: new transactions.AccessKeyPermission(Object.assign({}, action.params.accessKey.permission === "FullAccess" ? {
        fullAccess: new transactions.FullAccessPermission()
      } : {
        functionCall: new transactions.FunctionCallPermission({
  ...
  if (action.type === "DeleteKey") {
    return transactions.actionCreators.deleteKey(crypto.PublicKey.from(action.params.publicKey));
  }
  if (action.type === "DeleteAccount") {
    return transactions.actionCreators.deleteAccount(action.params.beneficiaryId);
  }
...
const verifySignature = ({
  ...
  const pk = crypto.PublicKey.from(publicKey);
...
Object.defineProperty(exports, 'SignedTransaction', {
    enumerable: true,
    get: function () { return transactions.SignedTransaction; }
});
Object.defineProperty(exports, 'actionCreators', {
    enumerable: true,
    get: function () { return transactions.actionCreators; }
});
Object.defineProperty(exports, 'Signer', {
    enumerable: true,
    get: function () { return signers.Signer; }
});
exports.EventEmitter = EventEmitter;
exports.allowOnlyLanguage = allowOnlyLanguage;
exports.getActiveAccount = getActiveAccount;
exports.internalActionToNaj = internalActionToNaj;
exports.isCurrentBrowserSupported = isCurrentBrowserSupported;
exports.najActionToInternal = najActionToInternal;
