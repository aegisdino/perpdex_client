...
var NEW_ITERATOR_PROTOTYPE = !isObject$4(IteratorPrototype$2) || fails$4(function () {
  var test = {};
...
const waitForNightlyNear = ({
  timeoutMs: _timeoutMs = 2000,
  intervalMs: _intervalMs = 50
} = {}) => __awaiter(void 0, void 0, void 0, function* () {
  return new Promise((resolve, reject) => {
    const start = Date.now();
    const check = () => {
      var _a;
      const injected = (_a = window === null || window === void 0 ? void 0 : window.nightly) === null || _a === void 0 ? void 0 : _a.near;
      if (injected) {
        resolve(injected);
        return;
      }
      if (Date.now() - start >= _timeoutMs) {
        reject(new Error("Nightly wallet not injected within timeout"));
        return;
      }
      setTimeout(check, _intervalMs);
    };
    check();
  });
});
const setupNightlyState = (store, emitter) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const wallet = yield waitForNightlyNear();
...
const Nightly = ({
  ...
  const signer = {
    signNep413Message: (message, accountId, recipient, nonce, callbackUrl) => __awaiter(void 0, void 0, void 0, function* () {
      const result = yield _state.wallet.signMessage({
        message,
      ...
      return Object.assign(Object.assign({}, result), {
        publicKey: crypto.PublicKey.fromString(result.publicKey),
        signature: Buffer.from(result.signature, "base64")
      });
    }),
    signTransaction: transaction => __awaiter(void 0, void 0, void 0, function* () {
      const signedTransaction = yield _state.wallet.signTransaction(transaction);
      return [Buffer.from(signedTransaction.signature.data), signedTransaction];
    }),
    getPublicKey: () => __awaiter(void 0, void 0, void 0, function* () {
      return crypto.PublicKey.fromString(_state.wallet.account.publicKey.toString());
    }),
    signDelegateAction: () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  return {
    ...
    signMessage({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const signature = yield _state.wallet.signMessage({
          message,
          nonce,
          recipient,
          state
