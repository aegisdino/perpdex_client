...
objectDefineProperty.f = DESCRIPTORS$6 ? nativeDefineProperty : function defineProperty(O, P, Attributes) {
  anObject$d(O);
...
var wellKnownSymbol$g = function (name) {
  if (!has$9(WellKnownSymbolsStore, name)) {
    if (NATIVE_SYMBOL && has$9(Symbol$1, name)) WellKnownSymbolsStore[name] = Symbol$1[name];
...
var getBuiltIn$6 = function (namespace, method) {
  return arguments.length < 2 ? aFunction$5(path[namespace]) || aFunction$5(global$d[namespace])
...
(redefine$8.exports = function (O, key, value, options) {
  ...
  if (typeof value == 'function') {
    if (typeof key == 'string' && !has$5(value, 'name')) createNonEnumerableProperty$5(value, 'name', key);
...
var objectAssign = !nativeAssign || fails$5(function () {
  ...
  if (DESCRIPTORS$2 && nativeAssign({ b: 1 }, nativeAssign(defineProperty({}, 'a', {
    enumerable: true,
    get: function () {
...
// `Object.assign` method
// https://tc39.github.io/ecma262/#sec-object.assign
$$5({ target: 'Object', stat: true, forced: Object.assign !== assign$1 }, {
  assign: assign$1
});
...
var speciesConstructor$1 = function (O, defaultConstructor) {
  ...
  var S;
  return C === undefined || (S = anObject$6(C)[SPECIES$2]) == undefined ? defaultConstructor : aFunction$2(S);
};
...
if (!set || !clear) {
  ...
  // Node.js 0.8-
  if (classof$4(process$3) == 'process') {
    defer = function (id) {
...
var IS_NODE$1 = classof$3(process$2) == 'process';
...
var IS_NODE = classof$2(process) == 'process';
...
var dispatchEvent = function (name, promise, reason) {
  ...
  if (handler = global$3['on' + name]) handler(event);
...
if (FORCED) {
  ...
  if (typeof NativePromise == 'function') {
    ...
    // wrap fetch result
    if (typeof $fetch$1 == 'function') $$4({ global: true, enumerable: true, forced: true }, {
      // eslint-disable-next-line no-unused-vars
      fetch: function fetch(input /* , init */) {
        return promiseResolve(PromiseConstructor, $fetch$1.apply(global$3, arguments));
      }
    });
  }
}
...
const MyNearWallet = ({
  ...
  const transformTransactions = transactions => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return Promise.all(transactions.map((transaction, index) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      return nearAPI__namespace.transactions.createTransaction(account.accountId, nearAPI__namespace.utils.PublicKey.from(accessKey.public_key), transaction.receiverId, nonce, actions, nearAPI__namespace.utils.serialize.base_decode(block.header.hash));
    })));
  });
  return {
    signIn({
